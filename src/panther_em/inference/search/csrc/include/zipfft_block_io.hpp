// Vendored from zipFFT (github.com Matthew Giammar), branch mdg_refactor_io,
// commit 4359d9ce2f957eb478c3c96cdac9b9a507252ef8, src/include/fp16_common.hpp.
//
// zipFFT source originally modified from from cuFFTDx examples in the
// CUDALibrarySamples repository under the Apache 2.0 License
...
// Basic I/O functionality for load/store operations on contiguous memory for
// cuFFTDx execution. Also Handles real-to-complex and complex-to-real
// load/store, but requires contiguous memory (e.g., values {r1, r2} <--> c1
